...
import {
  GenerateFillInTheBlankGameInputSchema,
  type GenerateFillInTheBlankGameInput,
  GenerateFillInTheBlankGameOutputSchema,
  type GenerateFillInTheBlankGameOutput
} from '@/ai/schemas/fill-in-the-blank-game-schemas';

export type { GenerateFillInTheBlankGameInput, GenerateFillInTheBlankGameOutput };
